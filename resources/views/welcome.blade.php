...
<html lang="en">
    <head>
        ...
        <title>HeyJobs - ¡Bienvenido!</title>
        <!-- Favicon-->
        ...
        <link href="{{ asset('/css/landigpage.css') }}" rel="stylesheet" />
    </head>
    <body id="page-top">
        <!-- Navigation-->
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">¡Bienvenido a <br>nuestra comunidad!</a><button class="navbar-toggler navbar-toggler-right text-uppercase font-weight-bold bg-primary text-white rounded" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation">Menu <i class="fas fa-bars"></i></button>
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#portfolio">Experiencia de nuestros usuarios</a></li>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">Conectando soluciones</p>
            </div>
        </header>
        <!-- Portfolio Section-->
        <section class="page-section portfolio" id="portfolio">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Experiencia de nuestros usuarios</h2>
                <!-- Icon Divider-->
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ml-auto">
                        <p class="lead">
                        Nuestra comunidad está formada por personas que ofrece un servicio
                        (individual o en grupos) y clientes que los requieren. En armonía
                        promovemos la sana competitividad y el constante asesoramiento
                        para hacer que el desempeño de cada integrante se aproveche al máximo
                        </p>
                    </div>
                    <div class="col-lg-4 mr-auto">
                        <p class="lead">
                            Puedes unirte a nuestra comunidad y ofrecer tus servicios al momento
                            a los clientes para producir más rápidamente, o bien, puedes contratar algún servicio, consultar
                            información y hacer preguntas en nuestro chat en línea. ¡Estás a un sólo click!
                        </p>
                    </div>
                </div>
                <!-- About Section Button-->
                <div class="text-center mt-4">
                    <a class="btn btn-xl btn-outline-light mx-3" href="{{route('showProvidersLogin') }}">{{-- <i class="fas fa-download mr-2"></i> --}}Se un proveedor</a>
                    <a class="btn btn-xl btn-outline-light mx-3" href="{{ route('login') }}">{{-- <i class="fas fa-download mr-2"></i> --}}Se un cliente</a>
                </div>
            </div>
        </section>
        <!-- Contact Section-->
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-5 mb-lg-0">
                        ...
                        <p class="lead mb-0">Oficinas de <br />Hey Jobs, MO 65243</p>
                    </div>
                    <!-- Footer Social Icons-->
                    <div class="col-lg-4 mb-5 mb-lg-0">
                    ...
                    <!-- Footer About Text-->
                    <div class="col-lg-4">
                        <h4 class="text-uppercase mb-4">Más sobre nuestra comunidad</h4>
        ...
        <div class="copyright py-4 text-center text-white">
            <div class="container"><small>Derechos reservados © HeyJobs! 2020</small></div>
        </div>
