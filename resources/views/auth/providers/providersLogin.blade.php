...
<body>
    ...
    <button class="button" onclick="window.location='{{ route('login') }}'" style="display: block;margin: 2% auto;border: none;background-color: #1161ee;color: white;padding: 6px 3%;border-radius: 911px;">Haz click aquí para ingresar como cliente</button>
<div class="login-wrap" style="margin-top: 5vh">
	<div class="login-html">
		<p class="text-center" style="height: 50px;"><br><br> PROVEEDORES <br></p>
		...
		<div class="login-form">
			<div class="sign-in-htm">
				<form action="{{ route('loginProviders') }}" method="POST" novalidate="novalidate">
					@csrf
					<div class="group">
